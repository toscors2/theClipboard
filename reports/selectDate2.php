...
echo "<br /><br /><br /><form name='startCount' method='POST' action='countReportSupplier.php'>
...
echo "<input type='submit' name='send2' value='Get Supplier Report'/></form>";
...
echo "<input type='submit' name='send2' value='Get Counts'/></form>";
